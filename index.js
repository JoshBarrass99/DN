...
function checkCreditField() {
    ...
    let f = document.getElementById('cardInput').value

    if (validateCardNumber(f) == true) {
        document.getElementById('cardInput').classList.add('makeGreen')
    }
    else document.getElementById("cardInput").classList.add("makeRed")
}
document.getElementById("cardInput").addEventListener(oninput, checkCreditField(f))
